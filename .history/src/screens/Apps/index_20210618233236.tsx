...
const AppsHome = () => {
    ...
    return <SafeAreaView style={styles.container}>
        ...
        <View style={styles.isi}>
            <Modal isOpen={viewDataStore} style={[styles.modal, styles.modal4]} position={"bottom"}>
                <Text style={styles.text}>Modal on bottom with backdrop</Text>
                <Slider style={{ width: 200 }} value={viewDataStore} onValueChange={(value) => setViewDataStore(value)} />
            </Modal>
            {
                <SectionGrid
                    itemDimension={155}
