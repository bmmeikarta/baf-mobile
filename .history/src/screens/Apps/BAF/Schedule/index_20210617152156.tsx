        ...
        <View style={styles.container}>
            ...
            <View style={{ padding: 10 }}>
                ...
                <Tab value={indexTower}>
                    <Tab.Item key={0} title="recent" onPress={() => setIndexTower(0)}/>
                    <Tab.Item key={1} title="favorite" onPress={() => setIndexTower(1)}/>
                    <Tab.Item key={2} title="cart" onPress={() => setIndexTower(2)}/>
                </Tab>
