...
const BAFReport = () => {
    ...
    const submitBAF = (data: any) => {
        let datanya = [{
            baf_cat_id: data.id,
            baf_photo: data.status === 'ok' ? '' : data.photo,
            baf_photo_status: data.status,
                ...
                <View style={styles.textContainer}>
                    ...
                    <View style={{
                        ...
                        <Button
                            ...
                            onPress={() => choosedBAF({...item, status: 'ok'})}
                        ...
                        <Button
                            ...
                            onPress={() => choosedBAF({...item, status: 'nok'})}
