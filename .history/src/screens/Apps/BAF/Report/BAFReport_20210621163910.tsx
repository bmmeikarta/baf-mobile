...
const BAFReport = () => {
    ...
    }, [JSON.stringify(Master.schedule_now), JSON.stringify(Master.categoryList)])
    ...
    const choosedBAF = (data: any, action: any) => {
        ...
        //     }
        //     setReportModal(true)
        // } else if(data.label === 'Keamanan') {
        //     setReportModal(true)
        // } else if(data.label === 'Fungsional') {
        //     setReportModal(true)
        // }
    }
    ...
    const submitBAF = (data:any , status: any) => {
        ...
        if (tempStore.length > 0) {
            const temp = tempStore.filter(obj1 => !datanya.some(obj2 => 
                ...
                obj1.baf_photo_status === obj2.baf_photo_status &&
                obj1.baf_id_user === obj2.baf_id_user &&
                obj1.baf_status === obj2.baf_status &&
