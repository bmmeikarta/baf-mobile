...
const BAFReport = () => {
    ...
    const submitBAF = (status: any) => {
        const datanya = [...Master.historyStore, {
            batch: Master.historyStore[Master.historyStore.length - 1].batch 
                ? Master.historyStore[Master.historyStore.length - 1].batch + 1
                : 1,
            hist: [
        ...
        console.log(datanya)
        // dispatch({ type: 'SET_INSERT_HISTORY', payload: data })
    }
