...
const ZoneChoose = () => {
    ...
    return <View style={styles.container}>
        ...
        <View style={{
            ...
            <TouchableOpacity onPress={() => dispatch({ type: 'SET_CHOOSED_ZONE', payload: 3 })} style={{ width: 50, height: 80 }}>
            ...
            <TouchableOpacity style={{ width: 170, height: 50 }} onPress={() => dispatch({ type: 'SET_CHOOSED_ZONE', payload: 2 })}>
            ...
            <TouchableOpacity style={{ width: 50, height: 80 }} onPress={() => dispatch({ type: 'SET_CHOOSED_ZONE', payload: 4 })}>
                <View style={{ width: 50, height: 80, justifyContent: 'center' }}>
                    <Svg width="50" height="80">
                        <Rect
                            x="0"
            ...
            <TouchableOpacity style={{ left: 170, bottom: 170, width: 50, height: 120 }} onPress={() => dispatch({ type: 'SET_CHOOSED_ZONE', payload: 1 })}>
        ...
        <Modal isOpen={scanQRCode} position={"bottom"} onClosed={() => setScanQRCode(false)}>
            <Text>Scan here</Text>
        </Modal>
    </View>
}
