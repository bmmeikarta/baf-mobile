        ...
        <View style={{
            ...
            <TouchableOpacity style={{ width: 50, height: 80 }}>
                <View style={{width: 50, height: 80, justifyContent: 'center' }}>
                    ...
                    <Text style={{ position: 'absolute', left: 3}}>Zone 3</Text>
                </View>
            </TouchableOpacity>
            <TouchableOpacity style={{ width: 170, height: 50 }}>
                <View style={{ width: 170, height: 50, justifyContent: 'center', alignContent: 'center' }}>
                    ...
                    <Text style={{ position: 'absolute', left: 3}}>Zone 2</Text>
                </View>
            </TouchableOpacity>
            <TouchableOpacity style={{ width: 50, height: 80 }}>
            ...
            <TouchableOpacity style={{ left: 170, bottom: 170, width: 50, height: 120 }}>
                <View>
